...
// Test that XCU operates correctly as an ERC20Basic token.
contract('ERC20Basic XCU', function ([_, admin, recipient, anotherAccount, owner]) {
  ...
  beforeEach(async function () {
    ...
    await proxiedXCU.initializeBalance(owner, 100);
  ...
  describe('basic data', function () {
    it('has getters for the name, symbol, and decimals', async function () {
      ...
      assert.equal(name, "CUPRUM");
      const symbol = await this.token.symbol();
      assert.equal(symbol, "XCU");
