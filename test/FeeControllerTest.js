...
// Tests that XCU fee controller capabilities function correctly.
contract('Fee Controller XCU', function ([_, admin, feeController, feeRecipient, recipient, otherAddress, owner]) {
    ...
    beforeEach(async function () {
        ...
        await proxiedXCU.initializeBalance(owner, ownerStartingBalance);
